...
path = __file__.replace('AnimInfoPage.py','')[:-1]
try:
    import maya.OpenMayaUI as apiUI
    import sip
    form, base = uic.loadUiType(path+'/anim_info_page.ui')
