...
//Name: test_createAttrs.ma
//Last modified: Sat, Mar 9, 2013 12:11:38 AM
//Codeset: UTF-8
requires maya "2010";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.9883572409752635 8.0517201119439754 19.994346085351555 ;
	setAttr ".r" -type "double3" -23.738352729620654 28.200000000000717 9.0223029139711863e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 29.288291777573995;
...
createNode pointConstraint -n "test_multiAxisRigPlanePointConst" -p "test_multiAxisRigPlane";
	...
	setAttr ".erp" yes;
	setAttr -k on ".w0";
createNode transform -n "test_multiAxisRigLoc" -p "test_multiAxisRigGrp";
