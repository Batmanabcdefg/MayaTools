...
//Name: test_setupRigHeirarchy.ma
//Last modified: Sat, Mar 9, 2013 12:10:08 AM
//Codeset: UTF-8
requires maya "2010";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.0664424961803709 10.196855849499004 16.201714169816608 ;
	setAttr ".r" -type "double3" -28.538352729620652 -4.9999999999992912 -1.9954399272777735e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 26.28542915693566;
...
createNode joint -n "joint3" -p "joint2";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".radi" 0.55172413793103448;
createNode transform -n "test_multiAxisRigPlane";
...
createNode nurbsSurface -n "test_multiAxisRigPlaneShape" -p "test_multiAxisRigPlane";
	...
	setAttr ".nufa" 4.5;
	setAttr ".nvfa" 4.5;
createNode pointConstraint -n "test_multiAxisRigPlanePointConst" -p "test_multiAxisRigPlane";
	addAttr -ci true -k true -sn "w0" -ln "joint2W0" -bt "W000" -dv 1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	setAttr -k off ".ty";
	...
	setAttr ".erp" yes;
	setAttr -k on ".w0";
createNode transform -n "test_multiAxisRigLoc";
createNode locator -n "test_multiAxisRigLocShape" -p "test_multiAxisRigLoc";
	setAttr -k off ".v";
createNode geometryConstraint -n "test_multiAxisRigLocGeoConst" -p "test_multiAxisRigLoc";
	addAttr -ci true -k true -sn "w0" -ln "test_multiAxisRigPlaneW0" -bt "W000" -dv 
		1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	...
	setAttr -k off ".sz";
	setAttr -k on ".w0";
createNode pointConstraint -n "test_multiAxisRigLocPointConst" -p "test_multiAxisRigLoc";
	addAttr -ci true -k true -sn "w0" -ln "joint3W0" -bt "W000" -dv 1 -min 0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	setAttr -k off ".ty";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".o" -type "double3" -1.9999999999999998 0 -2.7755575615628914e-17 ;
	setAttr ".rst" -type "double3" 1.0000000000000002 1 -2.7755575615628914e-17 ;
	setAttr -k on ".w0";
...
connectAttr "test_multiAxisRigPlanePointConst.ctx" "test_multiAxisRigPlane.tx";
connectAttr "test_multiAxisRigPlanePointConst.cty" "test_multiAxisRigPlane.ty";
connectAttr "test_multiAxisRigPlanePointConst.ctz" "test_multiAxisRigPlane.tz";
connectAttr "test_multiAxisRigPlane.pim" "test_multiAxisRigPlanePointConst.cpim"
		;
connectAttr "test_multiAxisRigPlane.rp" "test_multiAxisRigPlanePointConst.crp";
connectAttr "test_multiAxisRigPlane.rpt" "test_multiAxisRigPlanePointConst.crt";
connectAttr "joint2.t" "test_multiAxisRigPlanePointConst.tg[0].tt";
connectAttr "joint2.rp" "test_multiAxisRigPlanePointConst.tg[0].trp";
connectAttr "joint2.rpt" "test_multiAxisRigPlanePointConst.tg[0].trt";
connectAttr "joint2.pm" "test_multiAxisRigPlanePointConst.tg[0].tpm";
connectAttr "test_multiAxisRigPlanePointConst.w0" "test_multiAxisRigPlanePointConst.tg[0].tw"
		;
connectAttr "test_multiAxisRigLocGeoConst.cgm" "test_multiAxisRigLoc.g";
connectAttr "test_multiAxisRigLocPointConst.ctx" "test_multiAxisRigLoc.tx";
connectAttr "test_multiAxisRigLocPointConst.cty" "test_multiAxisRigLoc.ty";
connectAttr "test_multiAxisRigLocPointConst.ctz" "test_multiAxisRigLoc.tz";
connectAttr "test_multiAxisRigLoc.pim" "test_multiAxisRigLocGeoConst.cpim";
connectAttr "test_multiAxisRigPlaneShape.ws" "test_multiAxisRigLocGeoConst.tg[0].tgm"
		;
connectAttr "test_multiAxisRigLocGeoConst.w0" "test_multiAxisRigLocGeoConst.tg[0].tw"
		;
connectAttr "test_multiAxisRigLoc.pim" "test_multiAxisRigLocPointConst.cpim";
connectAttr "test_multiAxisRigLoc.rp" "test_multiAxisRigLocPointConst.crp";
connectAttr "test_multiAxisRigLoc.rpt" "test_multiAxisRigLocPointConst.crt";
connectAttr "joint3.t" "test_multiAxisRigLocPointConst.tg[0].tt";
connectAttr "joint3.rp" "test_multiAxisRigLocPointConst.tg[0].trp";
connectAttr "joint3.rpt" "test_multiAxisRigLocPointConst.tg[0].trt";
connectAttr "joint3.pm" "test_multiAxisRigLocPointConst.tg[0].tpm";
connectAttr "test_multiAxisRigLocPointConst.w0" "test_multiAxisRigLocPointConst.tg[0].tw"
		;
...
connectAttr "test_multiAxisRigLocShape.wp" "test_multiAxisRigCPOS.ip";
connectAttr "lightLinker1.msg" ":lightList1.ln" -na;
connectAttr "test_multiAxisRigPlaneShape.iog" ":initialShadingGroup.dsm" -na;
// End of test_setupRigHeirarchy.ma
